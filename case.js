...
var listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
  ...
  if (isCreator) return
  kice = m.sender
  await ALYA.groupParticipantsUpdate(m.chat, [kice], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
  }
  }
...
`
	                let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/aditadwir'
                                }
                            }]
             ...
             case 'antivirtex': {
                ...
                m.reply(`Antivirtex Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await ALYA.sendButtonText(m.chat, buttons, `Mode Antivirtex`, ALYA.user.name, m)
                }
             }
             break
            case 'ephemeral': {
